...
;out.print("${ajaxloader}");
;out.print(br.com.ampliato.devel.exo.addon.cartopins.templates.Cindex.s5);
...
public static final String s5 = '" id="loading-indicator" style="display:none" />\n        \n              </div>\n        \n              <button type="submit" class="btn btn-success">Search</button>\n        \n            </form>\n    \n        </div>\n        \n        <div class="col-sm-1">\n        </div>\n            \n        \n    </div>\n\n    <div id="map"></div>\n    \n</div>';
...
11:new juzu.impl.template.spi.juzu.dialect.gtmpl.Foo(new juzu.impl.common.Location(27,26),'ajaxloader')];
}
